...
export function ProjectDetailPage() {
  ...
  return (
    <div className="flex flex-col h-full bg-[#F8F8F6] overflow-hidden">

      {/* Zone 1 — Static header: breadcrumb + title + assignee/reporter + activity */}
      <div className="px-8 pt-7 pb-3 flex-shrink-0">
        ...
        {/* Activity label */}
        <h2 className="text-[11px] font-semibold uppercase tracking-wider text-gray-400 mb-1">Activity</h2>
      </div>
      ...
      {/* Zone 4 — Stories + Attachments: takes remaining height, scrollable */}
      <div className="flex-1 min-h-0 overflow-y-auto px-8 py-5 border-t border-gray-200">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-[11px] font-semibold uppercase tracking-wider text-gray-400">
            Stories {stories && stories.length > 0 && <span className="ml-1 normal-case font-normal tracking-normal">{stories.length}</span>}
          </h2>
          {canCreate && (
            <button
        ...
        <div className="space-y-3 mb-8">
          ...
          {stories?.length === 0 && !storiesLoading && (
            <div className="text-center py-10 text-gray-400">No stories in this project yet.</div>
          )}
        </div>
